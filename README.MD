...
| Excel                   | OAuth 2.0 | ⚠️ Coming soon                                                          | ⚠️ Requires Microsoft OAuth application              | [Excel Docs](/src/servers/excel/README.md)                      |
| Word                    | OAuth 2.0 | ⚠️ Coming soon                                                          | ⚠️ Requires Microsoft OAuth application              | [Word Docs](/src/servers/word/README.md)                        |
...
| Cal.com                 | API Key   | ⚠️ Coming soon                                                          | ⚠️ Requires Cal.com API key setup                    | [Cal.com Docs](/src/servers/calcom/README.md)                   |
...
| PostHog                 | API Key   | ⚠️ Coming soon                                                          | ✅ Easy - Simple API key setup                       | [PostHog Docs](/src/servers/posthog/README.md)                  |
| Salesforce              | OAuth 2.0 | ⚠️ Coming soon                                                          | ⚠️ Requires Salesforce Connected App setup  | [Salesforce Docs](/src/servers/salesforce/README.md)            |
| **Search Tools**        |           |                                                                         |                                                      |                                                                 |
...
| Apify                   | API Key   | ⚠️ Coming soon                                                          | ✅ Easy - Simple API key setup                       | [Apify Docs](/src/servers/apify/README.md)                      |
| **Development Tools**   |           |                                                                         |                                                      |                                                                 |
